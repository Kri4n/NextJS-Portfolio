...
const experience = [
  {
    ...
    current: true,
    highlights: [
      "Collaborated with cross-functional teams on a Flutter-based time & attendance app with VPN connection",
      "Integrated automated testing in Flutter using integration tests to reduce manual effort",
      "Optimized API response time by approximately 60–70%",
      "Developed a reverse geocoding service to process user locations",
      "Managed separate dev, staging, and production environments for multiple clients",
      "Implemented version checker with automated in-app updates",
    ],
  },
  {
    company: "U&I Global",
